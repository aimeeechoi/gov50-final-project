...
reg <- lm(formula = app_per_view ~ remote_allowed, 
          data = job_postings)
...
```{r}
multi_reg <- lm(formula = app_per_view ~ remote_allowed + `Salary Level` + application_type + sponsored, 
                data = job_postings)
...
Considering these limitations and threats to inference, there are several steps to take to bolster this analysis. 
